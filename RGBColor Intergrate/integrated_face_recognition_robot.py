...
class IntegratedRobotController:
    ...
    def __init__(self, root):
        ...
        self.current_colors = {i: "RED" for i in range(1, 17)}
    ...
    def run_welcome_sequence(self):
        ...
        def sequence():
            ...
            # Set all RGB to RED
            self.log_message("Setting RED...")
            for m in range(1, 17):
                self.set_motor_color(m, "RED")
                time.sleep(0.03)
            time.sleep(0.5)
            ...
            # BLUE for 5 seconds
            self.log_message("Setting BLUE for 10 seconds...")
            for m in range(1, 17):
                self.set_motor_color(m, "BLUE")
                time.sleep(0.03)
            time.sleep(5)
            
            # Reset to 0° for 5 seconds
